...
toolchains_musl = use_extension("//:toolchains_musl.bzl", "toolchains_musl", dev_dependency = True)
...
""",
        },
        {
            ...
            "run": f"./deterministic-tar.sh {output_path} MODULE.bazel musl_toolchains.bzl toolchains.bzl repositories.bzl BUILD.bazel bcr_test/MODULE.bazel bcr_test/BUILD.bazel bcr_test/binary_test.sh",
        },
    ]
